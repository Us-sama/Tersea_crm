...
<head>
    ...
    <style>
        ...
        body {
    background: linear-gradient(270deg, #f3f4f6, #d6d7db, #dae6e6);
...
<body class="antialiased" style="background-color: #F3F4F6">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light shadow-lg p-3 mb-5 bg-body rounded">
        ...
        <div class="container">
            ...
            <a class="navbar-brand me-2" href="#">
                <img src="https://tersea.digitalbled.com/wp-content/uploads/2020/03/logo-light-original.svg" height="46"
            ...
            <div class="collapse navbar-collapse" id="navbarButtonsExample">
                ...
                <div class="d-flex align-items-center">
                    ...
                    @auth('admin')
                    <a href="{{ route('admin.dashboard')}}" class="btn btn-dark-outline m-2">Admin dashboard</a>
                    @else
                    <a href="{{ route('admin.login')}}" class="btn btn-dark-outline m-2">Admin login</a>
                    @endauth
                </div>
            </div>
            <!-- Collapsible wrapper -->
    ...
    <div class="container mt-4 pt-4">
        <div class="row pt-4">
            <div class="col-1"></div>
            <div class="col-5">
                <h1 class=" mt-4 pt-4 display-5" style="font-weight:bold">Construisez l’avenir de votre relation client
                </h1>
                <p class="fs-5 pt-4">Tersea vous offre une gamme complète de services optimisés et personnalisés pour
                    améliorer l’expérience de vos clients.</p>
            </div>
            <div class="col-5">
                <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
                <lottie-player src="https://assets8.lottiefiles.com/packages/lf20_aynv58rp.json"
                    background="transparent" speed="1" style="width: 100%; height: auto;" loop autoplay></lottie-player>
